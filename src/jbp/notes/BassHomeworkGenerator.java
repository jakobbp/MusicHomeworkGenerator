...
public class BassHomeworkGenerator {
	...
	@GeneratorMethod(typeId = "2", description = "Bass homework sheets with TAB bars, where first quarter of notes correspond to empty bass strings in standard tuning and the other notes are random C major notes in first position.")
	...
	@GeneratorMethod(typeId = "3", description = "Bass homework sheets with TAB bars, where all notes are random C major notes in first position.")
